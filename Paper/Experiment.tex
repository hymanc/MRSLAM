...
\begin{figure}[ht]
\centering
\subfigure[$I_{filled}$ and the intersection with the ray $\textbf{v}_k$.]{\includegraphics[width=0.4\columnwidth]{../FinalFigures/RayCircleIntersection1}\label{subfig:raycirc}}
\subfigure[The selection of $r_k^*$.]{\includegraphics[width=0.4\columnwidth]{../FinalFigures/RayCircleIntersection}\label{subfig:rstar}}
